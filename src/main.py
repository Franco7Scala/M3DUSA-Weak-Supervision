...
if __name__ == "__main__":
    ...
    for cycle in range(al_cycles):
        ...
        current_data = k_hop_subgraph(data, sampling_mask[data.target_type], 2)
        # TODO plug labels in combined_output into current_data
        train(model, current_data, optimizer, criterion, n_epochs=training_epochs)
        # TODO implement active learning sampling strategy to update sampling_mask
        evaluate(model, current_data)
